...
function waktu() {
  ...
  const milidetik = d.getMilliseconds();
...
var x = setInterval(function() {
  ...
  document.getElementById("Tahun Baru").innerHTML = days + " Hari " + hours + " Jam "
    + minutes + " Menit " + seconds + " Detik ";
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("Tahun Baru").innerHTML = "Selamat Tahun Baru ";
  }
}, 1000);
